...
public class ExoPlayerRecyclerView extends RecyclerView {
    ...
    private OnLongClickListener videoViewOnLongClickListener = new OnLongClickListener() {
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        viewHolderParent.setOnLongClickListener(videoViewOnLongClickListener);
    ...
    private void animateVolumeControl() {
        if (volumeControl != null) {
            ...
            if (volumeState == VolumeState.OFF) {
                ...
                requestManager.load(R.drawable.ic_volum_on)
                        .into(volumeControl);
            }
